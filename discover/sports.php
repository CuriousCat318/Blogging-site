...
<body>
  ...
  <?php
  $query = "SELECT p.title,p.post,p.category,p.date,u.name,u.username from posts as p ,user_details as u  where p.uname=u.username and p.category='Sports' order by date DESC";
